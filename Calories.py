...
if __name__ == '__main__':
    calories_limit = 2000
    calories_calculator = CaloriesCalculator(calories_limit)
    calories_calculator.add_record(Record(amount=250, comment="пирожок"))
    print(calories_calculator.get_calories_remained())
    
    

    
   #Сегодня можно съесть что-нибудь ещё, но с общей калорийностью не более 1750 кКал
